...
# #自定义增加crontab任务
 ...
 echo "1 0,18 * * * sleep $((RANDOM % $RANDOM_DELAY_MAX)); node /scripts/jd_dpqd2.js >> /scripts/logs/jd_dpqd2.log 2>&1" >> /scripts/docker/merged_list_file.sh
 ...
 echo "18 23 1-21 4 * sleep $((RANDOM % $RANDOM_DELAY_MAX)); node /scripts/jd_sjkhc.js >> /scripts/logs/jd_sjkhc.log 2>&1" >> /scripts/docker/merged_list_file.sh
 ...
 echo "0 3-15/3,21,23 * * * sleep $((RANDOM % $RANDOM_DELAY_MAX)); node /scripts/jd_carnivalcitys.js >> /scripts/logs/jd_carnivalcitys.log 2>&1" >> /scripts/docker/merged_list_file.sh
