...
===========Loon============
[Script]
cron "4 8 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_unsubscribe.js,tag=取关京东店铺商品
============Surge=============
...
let shopPageSize = $.getdata('jdUnsubscribeShopPageSize') || 108;// 运行一次取消多少个已关注的店铺。数字0表示不取关任何店铺
