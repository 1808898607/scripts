...
echo "0 0 * * * sleep 1; node conc /scripts/sj_jd_carnivalcitys.js >> /scripts/logs/jd_carnivalcity.log 2>&1" >> /scripts/docker/merged_list_file.sh
...
echo "59 7,15,23 * * * sleep 56; node conc /scripts/jd_joy_reward.js >> /scripts/logs/jd_joy_rewardbf6.log 2>&1" >> /scripts/docker/merged_list_file.sh
